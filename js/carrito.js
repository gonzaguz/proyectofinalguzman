    ...
    if (productosEnCarrito && productosEnCarrito.length > 0) {
        ...
        productosEnCarrito.forEach(producto => {
            ...
            div.innerHTML = `
                ...
                <div
                    class="carrito-producto-cantidad">
                    <small>Cantidad</small>
                    <input class="carrito-producto-cantidad-input carritoProductoCantidad" type="number"
            ...
            div.querySelector('.carritoProductoCantidad').
...
function sumaCantidad(e){
    ...
    const titulo = div.querySelector('.titulo').textContent
    productosEnCarrito.forEach(producto => {
